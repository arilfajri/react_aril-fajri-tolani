...
import Table, { GET_PRODUCT } from "../table/Table";
...
const Form = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      imageProduct: Yup.string().required("Product Image is a required field"),
      radioProduct: Yup.string().required(
        "Product Freshness is a required field"
      ),
  ...
  const handleEdit = (newValues, event) => {
    ...
    updateProductt({
      variables: {
        ...
        additionalDescription: newValues.additionalDescription,
  ...
  return (
    <div>
      ...
      <Table handleSetEdit={handleSetEdit} />
    </div>
  );
};
